*&---------------------------------------------------------------------*
*& Report ZFAJR_GCBT_RP_3
*&---------------------------------------------------------------------*
*& Relatório Quantidade Caixas Pedido
*&---------------------------------------------------------------------*
REPORT zfajr_gcbt_rp_3.

" Relatório de Qtd Caixas por Venda
"   1 - Seleção de Dados (OK)
"       - Vendas, Caixas, Produto
"         - Vendas
"           - Produtos (Volume)
"             - Caixa (Dividir Total Volume)
"
"   2 - Manipular de Dados
"       - Calcular o Volume por Venda
"       - Calcular a Quantidade de Caixas
"   3 - Exibição de Dados
"       - Exibir a Quantidade de Caixas

TABLES: zfajr_gcbt_03.

" Filtros - Tela de Seleção
SELECT-OPTIONS: so_ped FOR zfajr_gcbt_03-id.

CLASS lcl_report DEFINITION.

  PUBLIC SECTION.

    DATA: lt_pedido      TYPE TABLE OF zfajr_gcbt_03,
          lt_pedido_item TYPE TABLE OF zfajr_gcbt_04.
    DATA: lt_produto     TYPE TABLE OF zfajr_gcbt_02.
    DATA: lt_caixa       TYPE TABLE OF zfajr_gcbt_01.

    TYPES: BEGIN OF ty_calc_vol_venda,
             id           TYPE zfajr_gcbt_el_1,
